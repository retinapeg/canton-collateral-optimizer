...
class PackageUploadTests(unittest.TestCase):
    ...
    def test_vetting_metadata_returns_unique_synchronizer_across_pages(self) -> None:
        client = self.client()
        ...
        matches, guard, synchronizers = cli._version_collisions({
        ...
        self.assertEqual(synchronizers, {"sync::one"})
    ...
    def test_upload_uses_participant_derived_synchronizer_without_serializing_it(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with mock.patch.object(cli, "inspect_dar", return_value=metadata), \
                 ...
                 mock.patch.object(
                     ...
                     "_version_collisions",
                     return_value=(
                         [], {"mode": "metadata", "checked": True}, {"sync::one"}
                     ),
                 ), \
                 mock.patch.object(
        ...
        self.assertEqual(result["synchronizerSelection"], "participant_metadata")
